...
function initialise() {
	...
	L0101 = theMenu.addChild(L01, "Document", "销售机会管理", "salesearchFirstPage", "销售机会管理...");
	L0102 = theMenu.addChild(L01, "Document", "客户开发计划", "planfirstPage", "客户开发计划...");

	
	L02 = theMenu.addChild(l2ID, "Folder", "客户管理", "", "客户管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户信息管理", "custfirstPage", "客户信息管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户流失管理", "lostfirstPage", "客户流失管理...");	

	L03 = theMenu.addChild(l2ID, "Folder", "服务管理", "", "客户服务管理...");
	L0301 = theMenu.addChild(L03, "Document", "服务创建", "cust/service/add.jsp", "服务创建...");
	L0302 = theMenu.addChild(L03, "Document", "服务处理", "servicefirstPage", "服务处理...");
	
	
	L04 = theMenu.addChild(l2ID, "Folder", "统计报表", "", "统计报表...");
	L0401 = theMenu.addChild(L04, "Document", "客户贡献分析", "reptcustTotal?cust=&year=", "客户贡献分析...");
	L0402 = theMenu.addChild(L04, "Document", "客户构成分析", "reptcustType?type=levelLabel", "客户构成分析...");
	L0403 = theMenu.addChild(L04, "Document", "客户服务分析", "reptservType?year=", "客户服务分析...");
	L0404 = theMenu.addChild(L04, "Document", "客户流失分析", "reptfirstPage?lostname=&lostmanager=", "客户流失分析...");
	
	L05 = theMenu.addChild(l2ID, "Folder", "基础数据", "", "基础数据...");
	L0501 = theMenu.addChild(L05, "Document", "数据字典管理", "dictionaryfirstPage", "数据字典管理...");
	L0502 = theMenu.addChild(L05, "Document", "查询产品信息", "productfirstPage", "查询产品信息...");
	L0503 = theMenu.addChild(L05, "Document", "查询库存", "storagefirstPage", "查询库存...");
    
    L06 = theMenu.addChild(l2ID, "Folder", "权限管理", "", "权限管理...");
	L0601 = theMenu.addChild(L06, "Document", "用户管理", "userselectFirstPage", "用户管理...");
	L0602 = theMenu.addChild(L06, "Document", "角色管理", "rolefirstPage", "角色管理...");
