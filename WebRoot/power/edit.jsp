...
<s:hidden name="id" value="%{#request.role.id}"/>
<table class="query_form_table">
	<tr>
		<th>编号</th>
		<td><input disabled="disabled" value="<s:property value="#request.role.id"/>"/></td>
		<th>角色名</th>
		<td><input id="roleName" name="roleName" value="<s:property value="#request.role.roleName"/>"/><span class="red_star">*</span></td>
	</tr>
	<tr>
		<th>指定权限</th>
	</tr>
